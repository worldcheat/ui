...
--[[
    ...
    function Section:Input(Data: table
        Name/name: string,
        Default/default: string,
        Placeholder/placeholder: string,
        Flag/flag: string,
        RemoveTextAfterFocusLost/removetextafterfocuslost: boolean,
        Callback/callback: function
    )
...
local Library do
    ...
    Library.Sections.Input = function(self, Data)
        ...
        local Input = {
            ...
            RemoveTextAfterFocusLost = Data.RemoveTextAfterFocusLost or Data.removetextafterfocuslost or false,
            Callback = Data.Callback or Data.callback or function() end,
        ...
        local Items = { } do 
            Items["Input"] = Instances:Create("Frame", {
                Parent = Input.Section.Elements["Content"].Instance,
                BackgroundTransparency = 1,
                Name = "\0",
                BorderColor3 = FromRGB(0, 0, 0),
                Size = UDim2New(1, 0, 0, 34),
        ...
        function Input:SetVisibility(Bool)
            Items["Input"].Instance.Visible = Bool
        end

        function Input:Set(Value)
            Input.Value = Value
            
            Items["Inline"].Instance.Text = Input.Value
            ...
            if Input.Callback then
                Library:SafeCall(Input.Callback, Input.Value)
            end
        end

        function Input:Clear()
            Items["Inline"].Instance.Text = ""
            Input:Set("")
        end
        ...
        Items["Inline"]:Connect("FocusLost", function()
            ...
            local newValue = Items["Inline"].Instance.Text
            Input:Set(newValue)
            
            if Input.RemoveTextAfterFocusLost then
                Items["Inline"].Instance.Text = ""
                Input.Value = ""
            end
        end)

        Items["Inline"]:Connect("ReturnPressedFromOnScreenKeyboard", function()
            local newValue = Items["Inline"].Instance.Text
            Input:Set(newValue)
        ...
        Library.SetFlags[Input.Flag] = function(Value)
            Input:Set(Value)
        end
